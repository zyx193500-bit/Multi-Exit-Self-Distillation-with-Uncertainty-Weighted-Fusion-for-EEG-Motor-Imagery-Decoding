"""
Model Name: CTNet - A Convolution-Transformer Network for EEG-Based Motor Imagery Classification

Citation: Zhao, W., Jiang, X., Zhang, B., et al. (2024). CTNet: A convolutional transformer
network for EEG-based motor imagery classification. Scientific Reports, 14, 20237.
https://doi.org/10.1038/s41598-024-71118-7

Original Repository: https://github.com/snailpt/CTNet

Implementation Source: This implementation was obtained from the official GitHub
repository and integrated into this benchmarking framework.

Note: All default hyperparameters and configurations follow those described
...
class CTNet(ClassificationModule):
    def __init__(
            self,
            n_channels: int ,
            n_classes: int ,
            ...
            eeg1_dropout_rate: float = 0.5,  # 0.25 for LOSO mode
            flatten_eeg1: int = 240,  
            **kwargs
